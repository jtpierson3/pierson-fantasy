...
export default function ClubSummaryTile({ team, rank, totalTeams }: Props) {
    ...
    return (
        <button
            ...
            className="w-full h-full text-left bg-yellow-400 hover:bg-yellow-300 transition-colors rounded-2xl p-5 flex flex-col justify-between h-40 overflow-hidden relative"
        >
            {/* Logo Placeholder */}
